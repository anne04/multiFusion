This repository presents a multimodal deep learning model for predicting time to biochemical recurrence by integrating MRI scans coming from different modalities, in particular, Apparent Diffusion Coefficient (ADC) maps, High b-value Diffusion (HBV),  and T2-weighted imaging with prostate mask. 
